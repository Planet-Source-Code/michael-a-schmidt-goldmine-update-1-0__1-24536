...
'################################################################
'# (C)2001 Michael Anthony Schmidt (mikes@mtdmarketing.com) ########
'#####################################################################
'# Release:     June 28, 2001   # For use with GoldMine 5   ############
'# Started:     June 25, 2001   # and the Borland Database  ##############
'################################ Engine.                   ################
'#                              ##############################################
'################################ This code is for demonstration purposes   #
'#  Startup (SubMain)           # only. Use at your own risk.              #
'##########################################################################
